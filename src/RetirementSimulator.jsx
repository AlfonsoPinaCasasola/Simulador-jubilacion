...
export default function RetirementSimulator() {
  ...
  return (
    <div className="max-w-xl mx-auto p-4 bg-white rounded-2xl shadow">
      <img src="https://drive.google.com/uc?export=view&id=1bCDJ4GccCSucR0VPGqaJtxtfHJg-YLdB" alt="Logo Truth Solutions" className="w-48 mx-auto mb-4" />
      <img src="https://drive.google.com/uc?export=view&id=1fQprpPKVtScvYvfPsQ5vMJw_xi0ftI0c" alt="Asesor" className="w-24 h-24 rounded-full mx-auto mb-4" />
